        ...
        <div>
            <div className="flex flex-row mt-70 sm:mt-70 md:mt-70 lg:mt-70">
                <div className="flex justify-between bg-sky-900 opacity-80 w-[58%] md:w-[80%] lg:w-[90%] h-auto p-4 sm:p-6 md:p-8 lg:p-20 text-gray-300">
                    <div className="text-xs sm:text-lg md:text-xl lg:text-2xl mt-10 sm:mt-15 md:mt-6 lg:mt-10 w-full font-serif">
                    ...
                    <div className="flex flex-col mt-10 sm:mt-15 md:mt-6 lg:mt-10 md:ml-40 w-full">
                        <h1 className="p-2 sm:p-3 text-[7px] sm:text-sm lg:text-lg font-serif tracking-wider">More about rooms</h1>
                        <div className="flex flex-col ml-2 sm:ml-4 text-[5px] sm:text-xs font-sans">
                ...
                <div className="w-[42%] md:w-[50%] lg:w-[50%] bg-sky-950 text-center p-4 sm:p-6 md:p-8 lg:p-10 lg:pt-20">
                    <div>
                        ...
                        <div>
                            <h1 className="text-white text-[7px] sm:text-xl font-serif tracking-widest p-2">
                                Wellness & Pools
                                <br />
                        ...
                        <div className="flex justify-center">
                            <span className="text-gray-400 text-[7px] sm:text-sm p-1 tracking-wider font-normal">
                                Building 1288
                                <br />
                                Road 3931, Block 339
                                <br />
                        ...
                        <div className="flex justify-center">
                            <span className="text-gray-400 text-[7px] sm:text-sm p-2 sm:p-7 tracking-wider font-normal leading-4 sm:leading-6">
                                +973 1730 7307
                                <br />
                        ...
                        <div className="flex justify-center">
                            <div className="p-1 mr-2">
                                <img src={insta} alt="Instagram Logo" className="w-3 h-3 sm:w-5 sm:h-5" />
                            </div>
                            <div className="p-1 mr-2">
                                <img src={facebook} alt="Facebook Logo" className="w-3 h-3 sm:w-5 sm:h-5" />
                            </div>
                            <div className="p-1">
                                <img src={youtube} alt="YouTube Logo" className="w-3 h-3 sm:w-5 sm:h-5" />
                            </div>
                        </div>
                    </div>
                </div>
