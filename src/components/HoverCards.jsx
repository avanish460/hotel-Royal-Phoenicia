...
function HoverCard({ imgUrl, title }) {
  ...
  return (
    <div className="flex justify-center p-2">
      ...
      >
        <span className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-xl sm:text-4xl md:text-6xl lg:text-7xl text-sky-900 font-serif tracking-wider font-thin transition-all duration-300 hover:text-white hover:scale-120 z-10">
          {title}
        </span>
        {isImageVisible && (
          <img
