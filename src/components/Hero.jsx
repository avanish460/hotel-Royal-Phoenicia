...
function Hero() {
  ...
  return (
    <div className="relative h-screen flex items-center justify-center text-center text-white overflow-hidden">
      ...
      {/* Content Overlay */}
      <div className="relative z-10 px-4 md:px-8 lg:px-16 mb-100 sm:mb-20 md:mb-4 lg:mb-4 text-center">
      ...
      <div className="absolute bottom-107 md:bottom-8 lg:bottom-8 left-11 z-30 text-gray-300 text-xs font-thin">
