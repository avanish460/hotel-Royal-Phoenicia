...
function EventVerticalScroll(){
  ...
  return (
    <div>
    <div className="absolute z-10 flex justify-center p-25 sm:p-40 w-40 h-62.5 sm:w-60 sm:h-50 md:w-80 md:h-100 lg:w-100 lg:h-125 overflow-y-auto scroll-smooth ml-15 sm:ml-35 md:ml-60 lg:ml-75"
    style={{
        scrollbarWidth: 'none', 
