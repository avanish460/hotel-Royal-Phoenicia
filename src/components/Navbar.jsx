    ...
    <nav className="absolute top-0 left-0 right-0 z-50 backdrop-blur-md shadow-md ">
      <div className="mx-auto py-1">
        ...
        <div className="flex items-center justify-between">
          {/* Menu Button */}
          <Button className="flex bg-sky-950 hover:bg-sky-900 text-white ml-2">
            {/* Hamburger Icon and "Menu" Text */}
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 sm:size-4 md:size-5 lg:size-5">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
            </svg>  

            <span className="ml-1 text-xs sm:text-xs md:text-sm lg:text-sm">Menu</span>
          </Button>
          ...
          {/* Booking Button */}
          <Button className="flex bg-sky-950 hover:bg-sky-900 text-white mr-2">
            <span className="mr-1 text-xs sm:text-xs md:text-sm lg:text-sm">Booking</span> 

            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 sm:size-4 md:size-5 lg:size-5">
