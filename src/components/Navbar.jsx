    ...
    <nav className="absolute top-0 left-0 right-0 z-50 backdrop-blur-md shadow-md ">
      <div className="container mx-auto py-1">
        ...
        <div className="hidden md:flex items-center justify-between">
          {/* Menu Button */}
          <Button className="flex bg-sky-950 hover:bg-sky-900 text-white ml-5">
          ...
          <div className="flex-grow flex justify-center">
            <span className="text-xs p-5 mr-5 tracking-[.75em] text-white">2022</span>

            <a href="/" className="block">
            <img src={royalPhoeniciaLogo} alt="Royal Phoenicia logo" className="h-12"/>
            </a>
            
            <div className="flex justigy-center text-xs p-5 ml-5 text-white">
          ...
          {/* Booking Button */}
          <Button className="flex bg-sky-950 hover:bg-sky-900 text-white mr-5">
        ...
        <div className="hidden md:block border-t border-gray-400">
          <div className="flex justify-center space-x-15 text-xs p-2">
        ...
        <div className="md:hidden flex items-center justify-between">
          {/* Mobile Menu Button */}
          <Button onClick={toggleMobileMenu} className="text-gray-200 hover:text-sky-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-sky-950">
            {/* Hamburger Icon */}
          ...
          {/* Hotel Logo (Mobile - likely centered) */}
          <div className="flex-grow flex justify-center">
          ...
          <Button className="flex bg-sky-950 hover:bg-sky-900 text-white">
            <span className="mr-1">Booking</span> 
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-sky-950 py-4">
            <div className="px-4 flex flex-col space-y-3">
            <a href="/" className="text-gray-400 hover:text-gray-100">ROOMS</a>
            <a href="/rooms" className="text-gray-400 hover:text-gray-100">WELLNESS</a>
            <a href="/amenities" className="text-gray-400 hover:text-gray-100">GASTRO</a>
            <a href="/contact" className="text-gray-400 hover:text-gray-100">HOTEL</a>
            <a href="/contact" className="text-gray-400 hover:text-gray-100">EVENTS</a>
